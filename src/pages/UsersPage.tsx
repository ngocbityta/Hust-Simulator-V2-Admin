    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-zinc-400 mt-2">Manage simulated entities and players</p>
        </div>
        ...
        <div className="flex gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 bg-zinc-950/50 border border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-zinc-100 placeholder-zinc-500 transition-all"
            />
          </div>
        </div>
              ...
              <tbody>
                {users.map((user: any) => (
                  <tr key={user.id} className="border-b border-zinc-800/50 hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td className="py-4 px-4 text-zinc-400 font-mono text-sm">{user.phonenumber}</td>
                    ...
                    <td className="py-4 px-4 text-right">
                      <button className="text-sm text-zinc-400 hover:text-blue-400 px-3 py-1.5 rounded-lg hover:bg-blue-400/10 transition-colors">
                        Edit
                      </button>
                    </td>
                  </tr>
